...
import org.reldb.rel.types.builtin.TypeRational;
...
public class ForeignCompilerJava {
    ...
    private static Type getTypeForClassName(Generator generator, String className) {
        if (className.equals("org.reldb.rel.values.ValueBoolean"))
            return TypeBoolean.getInstance();
        else if (className.equals("org.reldb.rel.values.ValueCharacter"))
            return TypeCharacter.getInstance();
        else if (className.equals("org.reldb.rel.values.ValueInteger"))
            return TypeInteger.getInstance();
        else if (className.equals("org.reldb.rel.values.ValueRational"))
            return TypeRational.getInstance();
        else if (className.equals("org.reldb.rel.values.ValueObject"))
            return TypeInteger.getInstance();
        else if (className.equals("org.reldb.rel.values.ValueOperator"))
	...
	public void compileForeignType(String name, String language, String src) {
        ...
        src = "package " + RelDatabase.getRelUserCodePackage() + ";\n" +
              ...
              "import org.reldb.rel.types.userdefined.*;\n" + 
