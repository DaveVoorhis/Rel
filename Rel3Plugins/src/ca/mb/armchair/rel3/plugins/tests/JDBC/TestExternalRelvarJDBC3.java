...
import ca.mb.armchair.rel3.plugins.tests.TestMySQLJDBCSettings;
...
public class TestExternalRelvarJDBC3 extends TestMySQLJDBCSettings {
	...
	public void testJDBC1() {
		...
		String src = 
				"BEGIN;\n" +
						"var myvar external jdbc \"" + absolutePath + "\" dup_count;" +
				"END;\n" +
				"true";
		testEquals("true", src);
	}
	...
	public void testJDBC2() {
		String src = "myvar";		
		testEquals(	"RELATION {DUP_COUNT INTEGER, A INTEGER, B INTEGER, C INTEGER} {" +
	...
	public void testJDBC3() {
		...
		} catch (SQLException e) {} catch (ClassNotFoundException e) {} catch (IOException e) {}
		testEquals("true", src);
	}
}
