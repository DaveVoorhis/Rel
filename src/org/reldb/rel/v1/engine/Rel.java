package org.reldb.rel.v1.engine;
...
import org.reldb.rel.v1.interpreter.ClassPathHack;
import org.reldb.rel.v1.interpreter.Instance;
import org.reldb.rel.v1.interpreter.Interpreter;
import org.reldb.rel.v1.interpreter.ParseExceptionPrinter;
import org.reldb.rel.v1.languages.tutoriald.parser.ParseException;
import org.reldb.rel.v1.languages.tutoriald.parser.TokenMgrError;
...
public class Rel {
	...
	public static void main(String[] args) throws IOException {
		buildClasspath();
		org.reldb.rel.v1.interpreter.Instance.main(args);
	}
