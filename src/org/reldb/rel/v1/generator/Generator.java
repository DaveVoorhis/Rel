...
import org.reldb.rel.v1.external.ForeignCompilerJava;
import org.reldb.rel.v1.interpreter.TutorialDParser;
import org.reldb.rel.v1.languages.tutoriald.BaseASTNode;
import org.reldb.rel.v1.languages.tutoriald.parser.Token;
import org.reldb.rel.v1.storage.BuiltinTypeBuilder;
import org.reldb.rel.v1.storage.RelDatabase;
import org.reldb.rel.v1.storage.relvars.Relvar;
import org.reldb.rel.v1.storage.relvars.RelvarCustomMetadata;
import org.reldb.rel.v1.storage.relvars.RelvarDefinition;
import org.reldb.rel.v1.storage.relvars.RelvarHeading;
import org.reldb.rel.v1.storage.relvars.RelvarInProgress;
import org.reldb.rel.v1.storage.relvars.RelvarMetadata;
import org.reldb.rel.v1.storage.relvars.RelvarPrivate;
import org.reldb.rel.v1.storage.relvars.RelvarRealMetadata;
import org.reldb.rel.v1.storage.relvars.RelvarVirtualMetadata;
import org.reldb.rel.v1.storage.tables.TableExternal.DuplicateHandling;
import org.reldb.rel.v1.types.Attribute;
import org.reldb.rel.v1.types.AttributeMap;
import org.reldb.rel.v1.types.Heading;
import org.reldb.rel.v1.types.JoinMap;
import org.reldb.rel.v1.types.OrderMap;
import org.reldb.rel.v1.types.Type;
import org.reldb.rel.v1.types.TypeAlpha;
import org.reldb.rel.v1.types.TypeArray;
import org.reldb.rel.v1.types.TypeHeading;
import org.reldb.rel.v1.types.TypeOperator;
import org.reldb.rel.v1.types.TypeRelation;
import org.reldb.rel.v1.types.TypeTuple;
import org.reldb.rel.v1.types.builtin.TypeBoolean;
import org.reldb.rel.v1.types.userdefined.DerivedPossrep;
...
import org.reldb.rel.v1.values.ValueRational;
...
import org.reldb.rel.v1.vm.instructions.array.OpArrayAppend;
import org.reldb.rel.v1.vm.instructions.array.OpArrayFor;
import org.reldb.rel.v1.vm.instructions.array.OpArrayGet;
import org.reldb.rel.v1.vm.instructions.array.OpArrayProject;
import org.reldb.rel.v1.vm.instructions.array.OpArraySet;
import org.reldb.rel.v1.vm.instructions.array.OpArrayToArray;
import org.reldb.rel.v1.vm.instructions.array.OpArrayToRelation;
import org.reldb.rel.v1.vm.instructions.core.OpAdd;
import org.reldb.rel.v1.vm.instructions.core.OpAverage;
import org.reldb.rel.v1.vm.instructions.core.OpBranchIfFalse;
import org.reldb.rel.v1.vm.instructions.core.OpConcatenate;
import org.reldb.rel.v1.vm.instructions.core.OpDuplicate;
import org.reldb.rel.v1.vm.instructions.core.OpDuplicateUnder;
import org.reldb.rel.v1.vm.instructions.core.OpExactly;
import org.reldb.rel.v1.vm.instructions.core.OpInvokeAnonymousEvaluate;
import org.reldb.rel.v1.vm.instructions.core.OpInvokeDynamicCall;
import org.reldb.rel.v1.vm.instructions.core.OpInvokeDynamicEvaluate;
import org.reldb.rel.v1.vm.instructions.core.OpJump;
import org.reldb.rel.v1.vm.instructions.core.OpLte;
import org.reldb.rel.v1.vm.instructions.core.OpOutput;
import org.reldb.rel.v1.vm.instructions.core.OpPop;
import org.reldb.rel.v1.vm.instructions.core.OpPreserveContextInValueOperator;
import org.reldb.rel.v1.vm.instructions.core.OpPushLiteral;
import org.reldb.rel.v1.vm.instructions.core.OpReturn;
import org.reldb.rel.v1.vm.instructions.core.OpReturnValue;
import org.reldb.rel.v1.vm.instructions.core.OpSwap;
import org.reldb.rel.v1.vm.instructions.core.OpWrite;
import org.reldb.rel.v1.vm.instructions.core.OpWriteRaw;
import org.reldb.rel.v1.vm.instructions.core.OpWriteln;
import org.reldb.rel.v1.vm.instructions.core.OpWritelnNoExpression;
import org.reldb.rel.v1.vm.instructions.possrep.OpPossrepGetComponent;
import org.reldb.rel.v1.vm.instructions.possrep.OpPossrepSetComponent;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationDUnion;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationGetTuple;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationIMinus;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationIntersect;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationJoin;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationLiteralInsertTuple;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationMap;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationMinus;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationOrder;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationProduct;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationProject;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationPushLiteral;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationTClose;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationUngroup;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationUnion;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationWhere;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationWrite;
import org.reldb.rel.v1.vm.instructions.relation.OpRelationXunion;
import org.reldb.rel.v1.vm.instructions.relation.OpTupleInRelation;
import org.reldb.rel.v1.vm.instructions.relvar.OpRelvarDeleteGivenExpression;
import org.reldb.rel.v1.vm.instructions.relvar.OpRelvarDeleteWhere;
import org.reldb.rel.v1.vm.instructions.relvar.OpRelvarGlobalGet;
import org.reldb.rel.v1.vm.instructions.relvar.OpRelvarIDelete;
import org.reldb.rel.v1.vm.instructions.relvar.OpRelvarInsert;
import org.reldb.rel.v1.vm.instructions.relvar.OpRelvarInsertNoDuplicates;
import org.reldb.rel.v1.vm.instructions.relvar.OpRelvarPurge;
import org.reldb.rel.v1.vm.instructions.relvar.OpRelvarUpdate;
import org.reldb.rel.v1.vm.instructions.relvar.OpRelvarUpdateWhere;
import org.reldb.rel.v1.vm.instructions.system.OpBackup;
import org.reldb.rel.v1.vm.instructions.system.OpCheckConstraintsAndCommitOrRollback;
import org.reldb.rel.v1.vm.instructions.system.OpCreateConstraint;
import org.reldb.rel.v1.vm.instructions.system.OpCreateExternalRelvar;
import org.reldb.rel.v1.vm.instructions.system.OpCreateOperator;
import org.reldb.rel.v1.vm.instructions.system.OpCreateRealRelvar;
import org.reldb.rel.v1.vm.instructions.system.OpCreateType;
import org.reldb.rel.v1.vm.instructions.system.OpCreateVirtualRelvar;
import org.reldb.rel.v1.vm.instructions.system.OpDropConstraint;
import org.reldb.rel.v1.vm.instructions.system.OpDropOperator;
import org.reldb.rel.v1.vm.instructions.system.OpDropRelvar;
import org.reldb.rel.v1.vm.instructions.system.OpDropType;
import org.reldb.rel.v1.vm.instructions.system.OpExecute;
import org.reldb.rel.v1.vm.instructions.system.OpTransactionBegin;
import org.reldb.rel.v1.vm.instructions.system.OpTransactionCommit;
import org.reldb.rel.v1.vm.instructions.system.OpTransactionRollback;
import org.reldb.rel.v1.vm.instructions.tuple.OpTupleGetAttribute;
import org.reldb.rel.v1.vm.instructions.tuple.OpTupleJoin;
import org.reldb.rel.v1.vm.instructions.tuple.OpTupleJoinDisjoint;
import org.reldb.rel.v1.vm.instructions.tuple.OpTupleProject;
import org.reldb.rel.v1.vm.instructions.tuple.OpTuplePushLiteral;
import org.reldb.rel.v1.vm.instructions.tuple.OpTupleSetAttribute;
