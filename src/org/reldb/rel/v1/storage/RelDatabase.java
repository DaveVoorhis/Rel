...
import org.reldb.rel.v1.external.DirClassLoader;
...
import org.reldb.rel.v1.storage.catalog.*;
...
import org.reldb.rel.v1.storage.relvars.RelvarPrivateCell;
import org.reldb.rel.v1.storage.relvars.RelvarReal;
import org.reldb.rel.v1.storage.relvars.RelvarRealMetadata;
import org.reldb.rel.v1.storage.tables.KeyTableNames;
import org.reldb.rel.v1.storage.tables.KeyTables;
import org.reldb.rel.v1.storage.tables.RegisteredTupleIterator;
import org.reldb.rel.v1.storage.tables.Table;
import org.reldb.rel.v1.storage.tables.TablePrivate;
...
public class RelDatabase {
	...
	private HashMap<String, org.reldb.rel.v1.types.Type> typeCache = new HashMap<String, org.reldb.rel.v1.types.Type>();
    ...
    public synchronized org.reldb.rel.v1.types.Type loadType(Generator generator, String typeName) {
    	...
    	org.reldb.rel.v1.types.Type type = typeCache.get(typeName);
    	if (type == null) {
	    	try {
		    	...
		    	if (language.equals("Rel")) {
					...
					try {
			            ...
			            Constructor<?> ctor = typeClass.getConstructor(new Class[] {org.reldb.rel.v1.generator.Generator.class});
			            if (ctor == null)
			            	throw new ExceptionSemantic("RS0211: Unable to find a constructor of the form " + typeName + "(Generator generator)");
						type = (org.reldb.rel.v1.types.Type)(ctor.newInstance(generator));
    ...
    public synchronized void dropType(final Generator generator, final String typeName) {
    	final org.reldb.rel.v1.types.Type type = loadType(generator, typeName);
    	try {
	    	(new TransactionRunner() {
	    		public Object run(Transaction txn) throws Throwable {
			...
			while (implementationIterator.hasNext()) {
				...
				if (existingImplementationSignature.equalsIgnoreCase(signature.toRelLookupString())) {
			    	...
			    	if (language.equals("Rel") || language.equals("System")) {
				    	...
				    	org.reldb.rel.v1.types.Type returnType;
						try {
