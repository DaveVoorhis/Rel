...
public class TestExternalRelvarXLSXAutokey extends XLSXTestHelper {
    @Before
    public void testXLS1() throws IOException {
        ...
        String src =
                "BEGIN;\n" +
                        "var myvar external xls \"" + file.getAbsolutePath().replace("\\", "\\\\") + "\" autokey;" +
                        "END;\n" +
                        "true";
        testEquals("true", src);
    }
