...
public abstract class ConcurrentStringReceiverClient {
	...
	private static class QueueEntry {
		...
		QueueEntry(Exception exception) {
			this.exception = exception;
			this.string = null;
		}

		QueueEntry(String string) {
			this.string = string;
			this.exception = null;
		}
	...
	/**
	 * Override to be notified that a string was received. This will run in the SWT
	 * widget thread so is safe to update SWT widgets.
	 */
	public abstract void received(String s);

	/**
	 * Override to be notified that an exception occurred. This will run in the SWT
	 * widget thread so is safe to update SWT widgets.
	 */
	public abstract void received(Exception e);

	/**
	 * Override to be notified that processing has finished. This will run in the
	 * SWT widget thread so is safe to update SWT widgets.
	 */
	public abstract void finished();

	/**
	 * Override to perform expensive periodic display updates after having received
	 * multiple strings. Safe to update SWT widgets.
	 */
