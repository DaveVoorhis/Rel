...
package org.reldb.dbrowser.ui.content.rev.old_rev.graphics.lines;
...
public class Block extends Composite {
    ...
    public Block(Composite parent, int xpos, int ypos, int width, int height) {
    	this(parent, xpos, ypos, width, height, new Color(parent.getDisplay(), 255, 25, 25));
    }
    ...
    public Block(Composite parent) {
    	this(parent, new Color(parent.getDisplay(), 255, 25, 25));
    }
}
