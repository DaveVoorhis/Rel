...
import org.reldb.rel.external.ForeignCompilerJava;
import org.reldb.rel.interpreter.TutorialDParser;
import org.reldb.rel.languages.tutoriald.BaseASTNode;
import org.reldb.rel.languages.tutoriald.parser.Token;
import org.reldb.rel.storage.BuiltinTypeBuilder;
...
import org.reldb.rel.storage.relvars.RelvarInProgress;
import org.reldb.rel.storage.relvars.RelvarMetadata;
import org.reldb.rel.storage.relvars.RelvarPrivate;
import org.reldb.rel.storage.relvars.RelvarRealMetadata;
import org.reldb.rel.storage.relvars.RelvarVirtualMetadata;
import org.reldb.rel.storage.tables.TableExternal.DuplicateHandling;
import org.reldb.rel.types.Attribute;
import org.reldb.rel.types.AttributeMap;
import org.reldb.rel.types.Heading;
import org.reldb.rel.types.JoinMap;
import org.reldb.rel.types.OrderMap;
import org.reldb.rel.types.Type;
import org.reldb.rel.types.TypeAlpha;
import org.reldb.rel.types.TypeArray;
import org.reldb.rel.types.TypeHeading;
import org.reldb.rel.types.TypeOperator;
import org.reldb.rel.types.TypeRelation;
import org.reldb.rel.types.TypeTuple;
import org.reldb.rel.types.builtin.TypeBoolean;
import org.reldb.rel.types.userdefined.DerivedPossrep;
...
import org.reldb.rel.vm.instructions.array.OpArrayAppend;
import org.reldb.rel.vm.instructions.array.OpArrayFor;
import org.reldb.rel.vm.instructions.array.OpArrayGet;
import org.reldb.rel.vm.instructions.array.OpArrayProject;
import org.reldb.rel.vm.instructions.array.OpArraySet;
import org.reldb.rel.vm.instructions.array.OpArrayToArray;
import org.reldb.rel.vm.instructions.array.OpArrayToRelation;
import org.reldb.rel.vm.instructions.core.OpAdd;
import org.reldb.rel.vm.instructions.core.OpAverage;
import org.reldb.rel.vm.instructions.core.OpBranchIfFalse;
import org.reldb.rel.vm.instructions.core.OpConcatenate;
import org.reldb.rel.vm.instructions.core.OpDuplicate;
import org.reldb.rel.vm.instructions.core.OpDuplicateUnder;
import org.reldb.rel.vm.instructions.core.OpExactly;
import org.reldb.rel.vm.instructions.core.OpInvokeAnonymousEvaluate;
import org.reldb.rel.vm.instructions.core.OpInvokeDynamicCall;
import org.reldb.rel.vm.instructions.core.OpInvokeDynamicEvaluate;
import org.reldb.rel.vm.instructions.core.OpJump;
import org.reldb.rel.vm.instructions.core.OpLte;
import org.reldb.rel.vm.instructions.core.OpOutput;
import org.reldb.rel.vm.instructions.core.OpPop;
import org.reldb.rel.vm.instructions.core.OpPreserveContextInValueOperator;
import org.reldb.rel.vm.instructions.core.OpPushLiteral;
import org.reldb.rel.vm.instructions.core.OpReturn;
import org.reldb.rel.vm.instructions.core.OpReturnValue;
import org.reldb.rel.vm.instructions.core.OpSwap;
import org.reldb.rel.vm.instructions.core.OpWrite;
import org.reldb.rel.vm.instructions.core.OpWriteRaw;
import org.reldb.rel.vm.instructions.core.OpWriteln;
import org.reldb.rel.vm.instructions.core.OpWritelnNoExpression;
import org.reldb.rel.vm.instructions.possrep.OpPossrepGetComponent;
import org.reldb.rel.vm.instructions.possrep.OpPossrepSetComponent;
import org.reldb.rel.vm.instructions.relation.OpRelationDUnion;
import org.reldb.rel.vm.instructions.relation.OpRelationGetTuple;
import org.reldb.rel.vm.instructions.relation.OpRelationIMinus;
import org.reldb.rel.vm.instructions.relation.OpRelationIntersect;
import org.reldb.rel.vm.instructions.relation.OpRelationJoin;
import org.reldb.rel.vm.instructions.relation.OpRelationLiteralInsertTuple;
import org.reldb.rel.vm.instructions.relation.OpRelationMap;
import org.reldb.rel.vm.instructions.relation.OpRelationMinus;
import org.reldb.rel.vm.instructions.relation.OpRelationOrder;
import org.reldb.rel.vm.instructions.relation.OpRelationProduct;
import org.reldb.rel.vm.instructions.relation.OpRelationProject;
import org.reldb.rel.vm.instructions.relation.OpRelationPushLiteral;
import org.reldb.rel.vm.instructions.relation.OpRelationTClose;
import org.reldb.rel.vm.instructions.relation.OpRelationUngroup;
import org.reldb.rel.vm.instructions.relation.OpRelationUnion;
import org.reldb.rel.vm.instructions.relation.OpRelationWhere;
import org.reldb.rel.vm.instructions.relation.OpRelationWrite;
import org.reldb.rel.vm.instructions.relation.OpRelationXunion;
import org.reldb.rel.vm.instructions.relation.OpTupleInRelation;
import org.reldb.rel.vm.instructions.relvar.OpRelvarDeleteGivenExpression;
import org.reldb.rel.vm.instructions.relvar.OpRelvarDeleteWhere;
import org.reldb.rel.vm.instructions.relvar.OpRelvarGlobalGet;
import org.reldb.rel.vm.instructions.relvar.OpRelvarIDelete;
import org.reldb.rel.vm.instructions.relvar.OpRelvarInsert;
import org.reldb.rel.vm.instructions.relvar.OpRelvarInsertNoDuplicates;
import org.reldb.rel.vm.instructions.relvar.OpRelvarPurge;
import org.reldb.rel.vm.instructions.relvar.OpRelvarUpdate;
import org.reldb.rel.vm.instructions.relvar.OpRelvarUpdateWhere;
import org.reldb.rel.vm.instructions.system.OpCheckConstraintsAndCommitOrRollback;
import org.reldb.rel.vm.instructions.system.OpCreateConstraint;
import org.reldb.rel.vm.instructions.system.OpCreateExternalRelvar;
import org.reldb.rel.vm.instructions.system.OpCreateOperator;
import org.reldb.rel.vm.instructions.system.OpCreateRealRelvar;
import org.reldb.rel.vm.instructions.system.OpCreateType;
import org.reldb.rel.vm.instructions.system.OpCreateVirtualRelvar;
import org.reldb.rel.vm.instructions.system.OpDropConstraint;
import org.reldb.rel.vm.instructions.system.OpDropOperator;
import org.reldb.rel.vm.instructions.system.OpDropRelvar;
import org.reldb.rel.vm.instructions.system.OpDropType;
import org.reldb.rel.vm.instructions.system.OpExecute;
import org.reldb.rel.vm.instructions.system.OpTransactionBegin;
import org.reldb.rel.vm.instructions.system.OpTransactionCommit;
import org.reldb.rel.vm.instructions.system.OpTransactionRollback;
import org.reldb.rel.vm.instructions.tuple.OpTupleGetAttribute;
import org.reldb.rel.vm.instructions.tuple.OpTupleJoin;
import org.reldb.rel.vm.instructions.tuple.OpTupleJoinDisjoint;
import org.reldb.rel.vm.instructions.tuple.OpTupleProject;
import org.reldb.rel.vm.instructions.tuple.OpTuplePushLiteral;
import org.reldb.rel.vm.instructions.tuple.OpTupleSetAttribute;
