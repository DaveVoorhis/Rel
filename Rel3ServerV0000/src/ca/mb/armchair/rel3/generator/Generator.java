...
import ca.mb.armchair.rel3.external.ForeignCompilerJava;
import ca.mb.armchair.rel3.interpreter.TutorialDParser;
import ca.mb.armchair.rel3.languages.tutoriald.BaseASTNode;
import ca.mb.armchair.rel3.languages.tutoriald.parser.Token;
import ca.mb.armchair.rel3.storage.BuiltinTypeBuilder;
...
import ca.mb.armchair.rel3.storage.relvars.RelvarInProgress;
import ca.mb.armchair.rel3.storage.relvars.RelvarMetadata;
import ca.mb.armchair.rel3.storage.relvars.RelvarPrivate;
import ca.mb.armchair.rel3.storage.relvars.RelvarRealMetadata;
import ca.mb.armchair.rel3.storage.relvars.RelvarVirtualMetadata;
import ca.mb.armchair.rel3.storage.tables.TableExternal.DuplicateHandling;
import ca.mb.armchair.rel3.types.Attribute;
...
import ca.mb.armchair.rel3.types.OrderMap;
import ca.mb.armchair.rel3.types.Type;
import ca.mb.armchair.rel3.types.TypeAlpha;
import ca.mb.armchair.rel3.types.TypeArray;
import ca.mb.armchair.rel3.types.TypeHeading;
import ca.mb.armchair.rel3.types.TypeOperator;
import ca.mb.armchair.rel3.types.TypeRelation;
import ca.mb.armchair.rel3.types.TypeTuple;
import ca.mb.armchair.rel3.types.builtin.TypeBoolean;
import ca.mb.armchair.rel3.types.userdefined.DerivedPossrep;
...
import ca.mb.armchair.rel3.vm.instructions.array.OpArrayAppend;
import ca.mb.armchair.rel3.vm.instructions.array.OpArrayFor;
import ca.mb.armchair.rel3.vm.instructions.array.OpArrayGet;
import ca.mb.armchair.rel3.vm.instructions.array.OpArrayProject;
import ca.mb.armchair.rel3.vm.instructions.array.OpArraySet;
import ca.mb.armchair.rel3.vm.instructions.array.OpArrayToArray;
import ca.mb.armchair.rel3.vm.instructions.array.OpArrayToRelation;
import ca.mb.armchair.rel3.vm.instructions.core.OpAdd;
import ca.mb.armchair.rel3.vm.instructions.core.OpAverage;
import ca.mb.armchair.rel3.vm.instructions.core.OpBranchIfFalse;
import ca.mb.armchair.rel3.vm.instructions.core.OpConcatenate;
import ca.mb.armchair.rel3.vm.instructions.core.OpDuplicate;
import ca.mb.armchair.rel3.vm.instructions.core.OpDuplicateUnder;
import ca.mb.armchair.rel3.vm.instructions.core.OpExactly;
import ca.mb.armchair.rel3.vm.instructions.core.OpInvokeAnonymousEvaluate;
import ca.mb.armchair.rel3.vm.instructions.core.OpInvokeDynamicCall;
import ca.mb.armchair.rel3.vm.instructions.core.OpInvokeDynamicEvaluate;
import ca.mb.armchair.rel3.vm.instructions.core.OpJump;
import ca.mb.armchair.rel3.vm.instructions.core.OpLte;
import ca.mb.armchair.rel3.vm.instructions.core.OpOutput;
import ca.mb.armchair.rel3.vm.instructions.core.OpPop;
import ca.mb.armchair.rel3.vm.instructions.core.OpPreserveContextInValueOperator;
import ca.mb.armchair.rel3.vm.instructions.core.OpPushLiteral;
import ca.mb.armchair.rel3.vm.instructions.core.OpReturn;
import ca.mb.armchair.rel3.vm.instructions.core.OpReturnValue;
import ca.mb.armchair.rel3.vm.instructions.core.OpSwap;
import ca.mb.armchair.rel3.vm.instructions.core.OpWrite;
import ca.mb.armchair.rel3.vm.instructions.core.OpWriteRaw;
import ca.mb.armchair.rel3.vm.instructions.core.OpWriteln;
import ca.mb.armchair.rel3.vm.instructions.core.OpWritelnNoExpression;
import ca.mb.armchair.rel3.vm.instructions.possrep.OpPossrepGetComponent;
import ca.mb.armchair.rel3.vm.instructions.possrep.OpPossrepSetComponent;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationDUnion;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationGetTuple;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationIMinus;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationIntersect;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationJoin;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationLiteralInsertTuple;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationMap;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationMinus;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationOrder;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationProduct;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationProject;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationPushLiteral;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationTClose;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationUngroup;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationUnion;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationWhere;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationWrite;
import ca.mb.armchair.rel3.vm.instructions.relation.OpRelationXunion;
import ca.mb.armchair.rel3.vm.instructions.relation.OpTupleInRelation;
import ca.mb.armchair.rel3.vm.instructions.relvar.OpRelvarDeleteGivenExpression;
import ca.mb.armchair.rel3.vm.instructions.relvar.OpRelvarDeleteWhere;
import ca.mb.armchair.rel3.vm.instructions.relvar.OpRelvarGlobalGet;
import ca.mb.armchair.rel3.vm.instructions.relvar.OpRelvarIDelete;
import ca.mb.armchair.rel3.vm.instructions.relvar.OpRelvarInsert;
import ca.mb.armchair.rel3.vm.instructions.relvar.OpRelvarInsertNoDuplicates;
import ca.mb.armchair.rel3.vm.instructions.relvar.OpRelvarPurge;
import ca.mb.armchair.rel3.vm.instructions.relvar.OpRelvarUpdate;
import ca.mb.armchair.rel3.vm.instructions.relvar.OpRelvarUpdateWhere;
import ca.mb.armchair.rel3.vm.instructions.system.OpCheckConstraintsAndCommitOrRollback;
import ca.mb.armchair.rel3.vm.instructions.system.OpCreateConstraint;
import ca.mb.armchair.rel3.vm.instructions.system.OpCreateExternalRelvar;
import ca.mb.armchair.rel3.vm.instructions.system.OpCreateOperator;
import ca.mb.armchair.rel3.vm.instructions.system.OpCreateRealRelvar;
import ca.mb.armchair.rel3.vm.instructions.system.OpCreateType;
import ca.mb.armchair.rel3.vm.instructions.system.OpCreateVirtualRelvar;
import ca.mb.armchair.rel3.vm.instructions.system.OpDropConstraint;
import ca.mb.armchair.rel3.vm.instructions.system.OpDropOperator;
import ca.mb.armchair.rel3.vm.instructions.system.OpDropRelvar;
import ca.mb.armchair.rel3.vm.instructions.system.OpDropType;
import ca.mb.armchair.rel3.vm.instructions.system.OpExecute;
import ca.mb.armchair.rel3.vm.instructions.system.OpTransactionBegin;
import ca.mb.armchair.rel3.vm.instructions.system.OpTransactionCommit;
import ca.mb.armchair.rel3.vm.instructions.system.OpTransactionRollback;
import ca.mb.armchair.rel3.vm.instructions.tuple.OpTupleGetAttribute;
import ca.mb.armchair.rel3.vm.instructions.tuple.OpTupleJoin;
import ca.mb.armchair.rel3.vm.instructions.tuple.OpTupleJoinDisjoint;
import ca.mb.armchair.rel3.vm.instructions.tuple.OpTupleProject;
import ca.mb.armchair.rel3.vm.instructions.tuple.OpTuplePushLiteral;
import ca.mb.armchair.rel3.vm.instructions.tuple.OpTupleSetAttribute;
