...
public class Context {
	...
	private Context(Context caller, Operator operator, Context varparms) {
		...
		// Adjust the caller context's stack pointer to remove the arguments from its
		// stack
	...
	// Join the ValueTuples on the stack. No checks are done to see if the tuples
	// share
	// attributes in common. It is assumed that they do not, and the result is
	// simply
