...
import ca.mb.armchair.rel3.client.Connection.HTMLReceiver;
import ca.mb.armchair.rel3.client.utilities.StringUtils;
import ca.mb.armchair.rel3.client.Error;
import ca.mb.armchair.rel3.client.NullTuples;
...
import ca.mb.armchair.rel3.rev.version.Version;
...
public class DatabaseAbstractionLayer {
	...
	private synchronized static Tuples getTuples(Connection connection, String query) {
		...
		if (response instanceof ca.mb.armchair.rel3.client.Error) {
