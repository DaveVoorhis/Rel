...
import ca.mb.armchair.rel3.storage.catalog.*;
...
import ca.mb.armchair.rel3.storage.relvars.RelvarPrivateCell;
import ca.mb.armchair.rel3.storage.relvars.RelvarReal;
...
import ca.mb.armchair.rel3.storage.tables.RegisteredTupleIterator;
import ca.mb.armchair.rel3.storage.tables.Table;
...
import ca.mb.armchair.rel3.generator.SlotScoped;
...
import ca.mb.armchair.rel3.external.DirClassLoader;
...
public class RelDatabase {
	...
	private HashMap<String, ca.mb.armchair.rel3.types.Type> typeCache = new HashMap<String, ca.mb.armchair.rel3.types.Type>();
    ...
    public synchronized ca.mb.armchair.rel3.types.Type loadType(Generator generator, String typeName) {
    	...
    	ca.mb.armchair.rel3.types.Type type = typeCache.get(typeName);
    	if (type == null) {
	    	try {
		    	...
		    	if (language.equals("Rel")) {
					...
					try {
						...
						type = (ca.mb.armchair.rel3.types.Type)(ctor.newInstance(generator));
    ...
    public synchronized void dropType(final Generator generator, final String typeName) {
    	final ca.mb.armchair.rel3.types.Type type = loadType(generator, typeName);
    	try {
	    	(new TransactionRunner() {
	    		public Object run(Transaction txn) throws Throwable {
			...
			while (implementationIterator.hasNext()) {
				...
				if (existingImplementationSignature.equalsIgnoreCase(signature.toRelLookupString())) {
			    	...
			    	if (language.equals("Rel") || language.equals("System")) {
				    	...
				    	ca.mb.armchair.rel3.types.Type returnType;
						try {
