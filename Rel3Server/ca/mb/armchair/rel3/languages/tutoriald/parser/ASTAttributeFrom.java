/* Generated By:JJTree: Do not edit this line. ASTAttributeFrom.java Version 4.3 */
...
public
class ASTAttributeFrom extends SimpleNode {
  public ASTAttributeFrom(int id) {
    super(id);
  }

  public ASTAttributeFrom(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=7eedf9194259095b6e26650bf0ef8338 (do not edit this line) */
