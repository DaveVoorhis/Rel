/* Generated By:JJTree: Do not edit this line. ASTAlgMinus.java Version 4.3 */
...
public
class ASTAlgMinus extends SimpleNode {
  public ASTAlgMinus(int id) {
    super(id);
  }

  public ASTAlgMinus(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=c114fd4daef991eb9d31df3bc8183ede (do not edit this line) */
