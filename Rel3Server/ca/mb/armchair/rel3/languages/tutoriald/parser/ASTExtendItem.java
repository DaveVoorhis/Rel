/* Generated By:JJTree: Do not edit this line. ASTExtendItem.java Version 4.3 */
...
public
class ASTExtendItem extends SimpleNode {
  public ASTExtendItem(int id) {
    super(id);
  }

  public ASTExtendItem(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=87f225cdf60885e544463b85f8e3f673 (do not edit this line) */
