/* Generated By:JJTree: Do not edit this line. ASTConcatenate.java Version 4.3 */
...
public
class ASTConcatenate extends SimpleNode {
  public ASTConcatenate(int id) {
    super(id);
  }

  public ASTConcatenate(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=a57dedcadb71e5b104006b5714db29f9 (do not edit this line) */
