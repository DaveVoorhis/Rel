/* Generated By:JJTree: Do not edit this line. ASTNadicHeading.java Version 4.3 */
...
public
class ASTNadicHeading extends SimpleNode {
  public ASTNadicHeading(int id) {
    super(id);
  }

  public ASTNadicHeading(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=d0f9f77ff1090b80d4e7e64ab2d20baa (do not edit this line) */
