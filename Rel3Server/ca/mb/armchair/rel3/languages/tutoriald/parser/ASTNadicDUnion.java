/* Generated By:JJTree: Do not edit this line. ASTNadicDUnion.java Version 4.3 */
...
public
class ASTNadicDUnion extends SimpleNode {
  public ASTNadicDUnion(int id) {
    super(id);
  }

  public ASTNadicDUnion(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=1c26af0addd2f72bc2effebd5d0cbf36 (do not edit this line) */
