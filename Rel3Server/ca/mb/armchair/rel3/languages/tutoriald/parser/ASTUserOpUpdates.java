/* Generated By:JJTree: Do not edit this line. ASTUserOpUpdates.java Version 4.3 */
...
public
class ASTUserOpUpdates extends SimpleNode {
  public ASTUserOpUpdates(int id) {
    super(id);
  }

  public ASTUserOpUpdates(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=50295b0ec6ec6e41c2e4eed53818e293 (do not edit this line) */
