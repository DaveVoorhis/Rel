/* Generated By:JJTree: Do not edit this line. ASTDerivedPossrepDef.java Version 4.3 */
...
public
class ASTDerivedPossrepDef extends SimpleNode {
  public ASTDerivedPossrepDef(int id) {
    super(id);
  }

  public ASTDerivedPossrepDef(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=a9ea95c8c34f399416c8519df7287ebb (do not edit this line) */
