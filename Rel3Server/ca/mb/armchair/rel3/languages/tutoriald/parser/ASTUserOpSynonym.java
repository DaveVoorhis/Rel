/* Generated By:JJTree: Do not edit this line. ASTUserOpSynonym.java Version 4.3 */
...
public
class ASTUserOpSynonym extends SimpleNode {
  public ASTUserOpSynonym(int id) {
    super(id);
  }

  public ASTUserOpSynonym(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=00d457c5a39fa38120bd6f9ae4a92336 (do not edit this line) */
