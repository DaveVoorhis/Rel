/* Generated By:JJTree: Do not edit this line. ASTDeleteParameter.java Version 4.3 */
...
public
class ASTDeleteParameter extends SimpleNode {
  public ASTDeleteParameter(int id) {
    super(id);
  }

  public ASTDeleteParameter(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=06648e0f669081047322628f2cabf018 (do not edit this line) */
