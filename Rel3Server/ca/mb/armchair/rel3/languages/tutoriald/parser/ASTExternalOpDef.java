/* Generated By:JJTree: Do not edit this line. ASTExternalOpDef.java Version 4.3 */
...
public
class ASTExternalOpDef extends SimpleNode {
  public ASTExternalOpDef(int id) {
    super(id);
  }

  public ASTExternalOpDef(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=2dccec8d95ab84f905763c6e9ff1c8e3 (do not edit this line) */
