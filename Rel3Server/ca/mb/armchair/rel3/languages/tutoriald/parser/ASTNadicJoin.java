/* Generated By:JJTree: Do not edit this line. ASTNadicJoin.java Version 4.3 */
...
public
class ASTNadicJoin extends SimpleNode {
  public ASTNadicJoin(int id) {
    super(id);
  }

  public ASTNadicJoin(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=607f8a1934893f3a6a378adc00a6cd2c (do not edit this line) */
