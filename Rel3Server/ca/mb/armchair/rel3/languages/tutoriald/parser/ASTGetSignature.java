/* Generated By:JJTree: Do not edit this line. ASTGetSignature.java Version 4.3 */
...
public
class ASTGetSignature extends SimpleNode {
  public ASTGetSignature(int id) {
    super(id);
  }

  public ASTGetSignature(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=d81ad43c498febb03227d76a67c2edfc (do not edit this line) */
