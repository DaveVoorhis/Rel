/* Generated By:JJTree: Do not edit this line. ASTExactly.java Version 4.3 */
...
public
class ASTExactly extends SimpleNode {
  public ASTExactly(int id) {
    super(id);
  }

  public ASTExactly(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=8229d4a992120cb10b96eb3fed09ce1a (do not edit this line) */
