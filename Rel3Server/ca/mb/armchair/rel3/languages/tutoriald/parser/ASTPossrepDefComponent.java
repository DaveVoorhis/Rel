/* Generated By:JJTree: Do not edit this line. ASTPossrepDefComponent.java Version 4.3 */
...
public
class ASTPossrepDefComponent extends SimpleNode {
  public ASTPossrepDefComponent(int id) {
    super(id);
  }

  public ASTPossrepDefComponent(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=76743bf67d84ac9e32514d2e44aa7616 (do not edit this line) */
