/* Generated By:JJTree: Do not edit this line. ASTEvaluate.java Version 4.3 */
...
public
class ASTEvaluate extends SimpleNode {
  public ASTEvaluate(int id) {
    super(id);
  }

  public ASTEvaluate(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=b324364e7d5b5119fdbe9f31eb1d62ff (do not edit this line) */
