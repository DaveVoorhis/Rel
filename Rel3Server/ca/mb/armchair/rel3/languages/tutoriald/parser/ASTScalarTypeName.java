/* Generated By:JJTree: Do not edit this line. ASTScalarTypeName.java Version 4.3 */
...
public
class ASTScalarTypeName extends SimpleNode {
  public ASTScalarTypeName(int id) {
    super(id);
  }

  public ASTScalarTypeName(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=2dc3d9a3d8088f651489bb6f42b13464 (do not edit this line) */
