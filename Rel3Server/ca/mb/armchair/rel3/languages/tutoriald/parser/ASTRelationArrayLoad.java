/* Generated By:JJTree: Do not edit this line. ASTRelationArrayLoad.java Version 4.3 */
...
public
class ASTRelationArrayLoad extends SimpleNode {
  public ASTRelationArrayLoad(int id) {
    super(id);
  }

  public ASTRelationArrayLoad(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=637de136f1d49cf396abb0e0e5a9f2a0 (do not edit this line) */
