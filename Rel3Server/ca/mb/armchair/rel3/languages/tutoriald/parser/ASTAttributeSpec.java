/* Generated By:JJTree: Do not edit this line. ASTAttributeSpec.java Version 4.3 */
...
public
class ASTAttributeSpec extends SimpleNode {
  public ASTAttributeSpec(int id) {
    super(id);
  }

  public ASTAttributeSpec(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=b25d7c0fd1a60d9962ea242fb3444c18 (do not edit this line) */
