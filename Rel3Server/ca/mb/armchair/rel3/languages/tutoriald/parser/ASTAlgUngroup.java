/* Generated By:JJTree: Do not edit this line. ASTAlgUngroup.java Version 4.3 */
...
public
class ASTAlgUngroup extends SimpleNode {
  public ASTAlgUngroup(int id) {
    super(id);
  }

  public ASTAlgUngroup(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=b6e9b12c46052d3bfb3012169c2c6f64 (do not edit this line) */
