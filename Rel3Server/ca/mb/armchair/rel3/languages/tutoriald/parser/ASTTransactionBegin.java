/* Generated By:JJTree: Do not edit this line. ASTTransactionBegin.java Version 4.3 */
...
public
class ASTTransactionBegin extends SimpleNode {
  public ASTTransactionBegin(int id) {
    super(id);
  }

  public ASTTransactionBegin(TutorialD p, int id) {
    super(p, id);
  }
...
/* JavaCC - OriginalChecksum=9f5afc0f46d5932330fbda6f7a1431e8 (do not edit this line) */
